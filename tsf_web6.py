...
wd = webdriver.Edge(executable_path="D:\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    print("Contact Page Verified Successful!\n")
except NoSuchElementException:
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Manisha Agarwal')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('manishaagarwal1607@gmail.com')
    time.sleep(3)
    ...
    time.sleep(3)
    print("Form Verified Successful!\n")
except NoSuchElementException:
